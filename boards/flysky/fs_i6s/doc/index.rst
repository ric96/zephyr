...
Supported Features
==================
Based on the hardware components, the following Zephyr subsystems can be
utilized:

* **GPIO:** Buttons, LEDs, and Display control
* **ADC:** Gimbals, switches, scroll wheels, and battery monitoring
* **I2C:** Capacitive touch controller
* **PWM:** Buzzer
* **Display:** 8-bit parallel interface LCD
* **UART:** Custom DIN4 connector
* **USB:** MicroUSB Port
